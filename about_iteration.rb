...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Iterates thru and array returns, in this case, an integer, using a block with two parameters, a result and an element. The element iterates, the results carries over with each iteration of the array element
  end
